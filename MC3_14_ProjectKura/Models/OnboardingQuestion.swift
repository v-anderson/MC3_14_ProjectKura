...
let onboardingQuestions = [
    ...
    OnboardingQuestion(question: "Now, I will tell you what has been bothering me these days...", questionsType: .single, answers: ["Let’s Hear It"], goodAnswer: 0, isLongQuestion: false),
